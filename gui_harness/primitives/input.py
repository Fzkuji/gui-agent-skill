...
def mouse_move(x: int, y: int):
    ...
    from platform_input import mouse_move as _move
    _move(x, y)
...
def mouse_drag(start_x: int, start_y: int, end_x: int, end_y: int,
    ...
    from platform_input import mouse_drag as _drag
    _drag(start_x, start_y, end_x, end_y, duration=duration, button=button)
...
def set_clipboard(text: str):
    ...
    from platform_input import set_clipboard as _set
    _set(text)


def get_clipboard() -> str:
    """Get clipboard contents."""
    from platform_input import get_clipboard as _get
    return _get()
...
def capture_window(app_name: str, out_path: str = None) -> str:
    """Capture a window screenshot."""
    from platform_input import capture_window as _capture
    return _capture(app_name, out_path)
